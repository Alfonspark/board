        ...
        <section class="content-header">
          <h1>
            ...
            <c:if test="${not empty login }" >
            	<strong style="color:#3c8dbc;font-size:13px;padding-left:10px;">${sessionScope.login.uid }</strong>
            	<a href="/user/logout" style="color:#3c8dbc;font-size:13px;">/LOGOUT</a>
            </c:if>
            <c:if test="${empty login }" >
            	<a href="/user/login" style="color:#3c8dbc;font-size:13px;">LOGIN</a>
            </c:if>
          </h1>
          <ol class="breadcrumb">
